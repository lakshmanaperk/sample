...
public abstract class ExecutableCommand extends Command {
	 ...
	 * 
	 * Include your own executables, renamed from * to lib*_exec.so, in your
	 * libs folder under the architecture directories. Now they will be deployed
	 * by Android the same way libraries are deployed!
	 * 
	 ...
	 * @param parameters
	 */
	public ExecutableCommand(Context context, String executableName,
			String parameters) {
		super(getLibDirectory(context) + File.separator + EXECUTABLE_PREFIX
				+ executableName + EXECUTABLE_SUFFIX + " " + parameters);
	}
