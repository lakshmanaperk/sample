...
/**
 * This methods work when the apk is installed as a system app (under
 * /system/app)
 */
public class SystemCommands {
	...
	/**
	 * Reboot the device immediately, passing 'reason' (may be null) to the
	 * underlying __reboot system call. Should not return.
	 * 
	...
	// try {
	// Class<?> clazz =
	// Class.forName("com.android.internal.app.ShutdownThread");
	//
	// // if (mReboot) {
	...
	// // } else {
	// // Method method = clazz.getMethod("shutdown", Context.class,
	// Boolean.TYPE);
	...
	//
	// // PowerManager.reboot() is documented not to return so just wait for the
	// inevitable.
